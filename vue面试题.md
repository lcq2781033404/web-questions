...
#### （1）父子组件传值
父子组件传值使用props在子组件进行接收，用法很简单，这里要说明props传值的一个原则：**单向数据流**，即props传递的值的改变应该是自上而下的，子组件中不应该去修改props的值。并且**通过props传递到子组件的数组或对象是一个引用，在子组件中改变变更这个对象或数组本身将会影响到父组件的状态**（这句话官网有写：https://cn.vuejs.org/v2/guide/components-props.html#%E4%BC%A0%E5%85%A5%E4%B8%80%E4%B8%AA%E6%95%B0%E7%BB%84）
